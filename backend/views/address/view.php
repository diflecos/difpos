...
<div class="address-view row">
	...
	<a href="#" data-toggle="modal" data-target="#modal-address-update"><span class="glyphicon glyphicon-pencil"></span></a>
	...
	<?php
	Modal::begin([
		'id' => 'modal-address-update',
		'header' => '<h4>Update Address</h4>'
	]);
	
	echo $this->render('//address/update', ['model' => $model]);
