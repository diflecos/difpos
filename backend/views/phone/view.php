...
<div class="phone-view row">
	...
	<a href="#" data-toggle="modal" data-target="#modal-phone-update"><span class="glyphicon glyphicon-pencil"></span></a>
	<a href="<?= Url::to(['phone/delete', 'id' => $model->id]) ?>"><span class="glyphicon glyphicon-remove"></span></a>
	
	<?php
	Modal::begin([
		'id' => 'modal-phone-update',
		'header' => '<h4>Update Phone</h4>'
	]);
	
	echo $this->render('//phone/update', ['model' => $model]);
