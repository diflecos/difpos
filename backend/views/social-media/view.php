...
<div class="social-media-view row">
	...
	<a href="#" data-toggle="modal" data-target="#modal-social-media-update"><span class="glyphicon glyphicon-pencil"></span></a>
	<a href="<?= Url::to(['social-media/delete', 'id' => $model->id]) ?>"><span class="glyphicon glyphicon-remove"></span></a>
	
	<?php
	Modal::begin([
		'id' => 'modal-social-media-update',
		'header' => '<h4>Update Social Media</h4>'
	]);
	
	echo $this->render('//social-media/update', ['model' => $model]);
