...
/**
 * This is the model class for table "check_transaction".
 *
 * @property string $id
 ...
 */
class CheckTransaction extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['payment_id', 'amount', 'currency_id', 'check_id'], 'required'],
            [['payment_id', 'currency_id', 'transaction_annulation_id'], 'integer'],
            [['flow_direction'], 'string'],
            [['amount'], 'number'],
            [['effective_on'], 'safe'],
            [['check_id', 'bank'], 'string', 'max' => 45],
            [['check_id'], 'unique']
        ];
    }
